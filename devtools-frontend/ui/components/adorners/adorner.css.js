...
:host(:focus) slot {
  border-color: var(--override-adorner-focus-border-color, var(--color-primary-old));
}

:host([aria-pressed="true"]) slot {
  color: var(--override-adorner-active-text-color, var(--color-background));
  background-color: var(--override-adorner-active-background-color, var(--color-primary-old));
  border: 1px solid var(--override-adorner-active-background-color, var(--color-primary-old));
}
