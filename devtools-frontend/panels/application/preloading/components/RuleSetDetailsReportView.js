...
const str_ = i18n.i18n.registerUIStrings('panels/application/preloading/components/RuleSetDetailsReportView.ts', UIStrings);
...
export class RuleSetDetailsReportView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
    static litTagName = LitHtml.literal `devtools-resources-rulesets-details-report-view`;
    ...
    async #render() {
        ...
        <${ReportView.ReportView.Report.litTagName} .data=${{ reportTitle: 'SpeculationRules rule set' }}>
          ...
          <${ReportView.ReportView.ReportKey.litTagName}>${i18nString(UIStrings.detailsValidity)}</${ReportView.ReportView.ReportKey.litTagName}>
          ...
          <${ReportView.ReportView.ReportKey.litTagName}>${i18nString(UIStrings.detailsError)}</${ReportView.ReportView.ReportKey.litTagName}>
          <${ReportView.ReportView.ReportValue.litTagName}>
            <div class="text-ellipsis" title="">
              ${error}
            </div>
    ...
    #location() {
        ...
        if (this.#data.backendNodeId !== undefined) {
            ...
            // clang-format off
            return LitHtml.html `
          <${ReportView.ReportView.ReportKey.litTagName}>${i18nString(UIStrings.detailsLocation)}</${ReportView.ReportView.ReportKey.litTagName}>
          <${ReportView.ReportView.ReportValue.litTagName}>
    ...
    async #revealSpeculationRulesInElements() {
    ...
    async #revealSpeculationRulesInNetwork() {
    ...
    #source(sourceText) {
        ...
        if (sourceJson === undefined) {
            ...
            // clang-format off
            return LitHtml.html `
          <${ReportView.ReportView.ReportKey.litTagName}>${i18nString(UIStrings.detailsSource)}</${ReportView.ReportView.ReportKey.litTagName}>
          <${ReportView.ReportView.ReportValue.litTagName}>
            <div class="text-ellipsis" title="">
              ${sourceText}
            </div>
