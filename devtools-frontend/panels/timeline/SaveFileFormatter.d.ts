 ...
 */
export declare function traceJsonGenerator(traceEvents: readonly TraceEngine.Types.TraceEvents.TraceEventData[], metadata: Readonly<TraceEngine.TraceModel.TraceFileMetaData> | null): IterableIterator<string>;
/**
